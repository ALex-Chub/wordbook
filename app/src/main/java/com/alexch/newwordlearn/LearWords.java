...
public class LearWords extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LearnWordAdapter adapter = new LearnWordAdapter(this, R.layout.listlearnitem, learningwordarray);
        VerbLernAdapter verbLernAdapter = new VerbLernAdapter(this,R.layout.learnverbitem, verbsArrayList);
        NounLernAdapter nounLernAdapter = new NounLernAdapter( this, R.layout.neunlernitem, nounArrayList);
                ...
                myRef.child("Users").child(userid).child("Word").addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String previousChildName) {
                        ...
                        if (word != null) {
                            ...
                            Toast.makeText(LearWords.this, "Ошибка", Toast.LENGTH_SHORT).show();
    ...
    public void gostats(View view){
        Intent intent = new Intent(LearWords.this, PersonalStats.class);startActivity(intent);
    }

    public void gotoaddword(View view){
        Intent intent = new Intent(LearWords.this, AddWord.class); startActivity(intent);
    }

    public  void gotolib(View view){
        Intent intent = new Intent(LearWords.this, LibraryWords.class); startActivity(intent);
    }
